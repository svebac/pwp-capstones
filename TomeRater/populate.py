...
Tome_Rater.add_user("Hans Meier", "hans@meier.de", user_books=[novel2, novel3, nonfiction1])
#Test already existing ISBN
Tome_Rater.add_user("Lothar Luder", "lothar.luder@computation.org", user_books=[book2, book1, nonfiction1])
